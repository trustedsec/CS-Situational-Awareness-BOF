...
void customAttributes(PCHAR pAttribute, PCHAR pValue)
{
    if(MSVCRT$strcmp(pAttribute, "objectGUID") == 0) 
    {
        ...
        frpcstringfree(&G);
    } else if (MSVCRT$strcmp(pAttribute, "nTSecurityDescriptor") == 0 || MSVCRT$strcmp(pAttribute, "msDS-AllowedToActOnBehalfOfOtherIdentity") == 0 || MSVCRT$strcmp(pAttribute, "schemaIDGUID") == 0) {
		char *encoded = NULL;
		PBERVAL tmp = (PBERVAL)pValue;
    ...
    do
    {
        ...
        for( iCnt=0; iCnt < numberOfEntries; iCnt++ )
        {
            ...
            while(pAttribute != NULL)
            {
				...
				if(MSVCRT$strcmp(pAttribute, "objectSid") == 0 || MSVCRT$strcmp(pAttribute, "objectGUID") == 0 || MSVCRT$strcmp(pAttribute, "nTSecurityDescriptor") == 0 || MSVCRT$strcmp(pAttribute, "msDS-AllowedToActOnBehalfOfOtherIdentity") == 0 | MSVCRT$strcmp(pAttribute, "schemaIDGUID") == 0)
                {
					//internal_printf("\n%s\n", pAttribute);
